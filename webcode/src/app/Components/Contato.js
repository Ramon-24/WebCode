        ...
        <section className="contato" id="contato" style={{ paddingTop: "100px" }}>
            ...
            <div className="Area-contato">
                <div className="Inf-contato">
                    ...
                    <div className="Inf-cards-contato">
                        {/* WhatsApp */}
                        <div className="Inf-card-contato">
                            ...
                            <div className="Inf-text-contato">
                                <h3>{t.contatos[0].tipo}</h3>
                                <p>{t.contatos[0].valor}</p>
                            </div>
                        </div>
                        ...
                        <div className="Inf-card-contato">
                            ...
                            <div className="Inf-text-contato">
                                <h3>{t.contatos[1].tipo}</h3>
                                <p>{t.contatos[1].valor}</p>
                            </div>
                        </div>
                        ...
                        <div className="Inf-card-contato">
                            ...
                            <div className="Inf-text-contato">
                                <h3>{t.contatos[2].tipo}</h3>
                                <p>{t.contatos[2].valor}</p>
                            </div>
                        </div>
                        ...
                        <div className="Inf-card-contato">
                            ...
                            <div className="Inf-text-contato">
                                <h3>{t.contatos[3].tipo}</h3>
                                <p>{t.contatos[3].valor}</p>
                            </div>
                        </div>
                    </div>
                </div>
